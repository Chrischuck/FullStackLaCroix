export default {
  ...
  "cran-raspberry": {
    id: "cran-raspberry",
    img:
      "https://www.lacroixwater.com/wp-content/uploads/2019/01/CRAN-RASPBERRY.png",
    name: "Cran-Raspberry",
    description:
      "Cran-Raspberry: a mixture of two great tastes that’s berry delightful with nothing artificial."
  },
  pamplemousse: {
    id: "pamplemousse",
    img:
      "https://www.lacroixwater.com/wp-content/uploads/2019/01/PAMPLEMOUSSE-1.png",
    name: "Pamplemousse",
    description:
      "Pamplemousse: it’s the French translation for the word grapefruit and show of humor from this all-American brand."
  },
  peach_pear: {
    id: "peach_pear",
    img:
      "https://www.lacroixwater.com/wp-content/uploads/2019/01/PEACH-PEAR.png",
    name: "Peach Pear",
    description:
      "Peach Pear: combines the sweet smell of peach with a rounded pear taste."
  },
  coconut: {
    id: "coconut",
    img:
  ...
  tangerine: {
    id: "tangerine",
    img:
      "https://www.lacroixwater.com/wp-content/uploads/2019/01/TANGERINE-1.png",
    name: "Tangerine",
    description:
      "Tangerine: freshly peeled aroma and Tangerr -EEN effervescence to transport your taste buds! Available now in select markets."
  },
  key_lime: {
    id: "key_lime",
    img:
      "https://www.lacroixwater.com/wp-content/uploads/2019/01/KEYLIME-1.png",
    name: "Key Lime",
    description:
      "Starts with a creamy note of toasted meringue, followed by the tart, crisp KeyLime essence, trailing with a rich, graham cracker finish."
  }
};
